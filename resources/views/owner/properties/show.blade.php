        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div>
                    ...
                    <p class="text-gray-700">{{ $property->phone ?? '-' }}</p>
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="space-y-2">
                <a href="{{ route('owner.properties.edit', $property) }}"
                   class="block w-full text-center bg-indigo-50 text-indigo-600 px-4 py-2 rounded-lg text-sm hover:bg-indigo-100">
                    Edit Properti
                </a>
                <a href="{{ route('owner.properties.rooms.index', $property) }}"
                   class="block w-full text-center bg-gray-50 text-gray-600 px-4 py-2 rounded-lg text-sm hover:bg-gray-100">
                    Kelola Kamar
                </a>
                <form method="POST" action="{{ route('owner.properties.destroy', $property) }}"
                    ...
                    @csrf @method('DELETE')
                    <button type="submit"
                            class="w-full bg-red-50 text-red-600 px-4 py-2 rounded-lg text-sm hover:bg-red-100">
                        Hapus Properti
                    </button>
                </form>
            </div>
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="flex items-center justify-between px-6 py-4 border-b">
                ...
                <a href="{{ route('owner.properties.rooms.index', $property) }}"
                   class="text-sm text-indigo-600 hover:underline">Kelola</a>
            </div>
